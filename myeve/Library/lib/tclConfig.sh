...
# installed.
TCL_PREFIX='D:/project/ml project/myeve\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/project/ml project/myeve\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/project/ml project/myeve\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/project/ml project/myeve\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/project/ml project/myeve\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/project/ml project/myeve\Library\lib\tclstub86.lib'
